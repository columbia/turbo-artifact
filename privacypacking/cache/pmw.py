...
class histogram:
    ...
    def get_bins(self, query_id):       # Gives us direct access to the bins we are interested in
...
class PerBlockPMW:
    def __init__(self, scheduler):
        ...
        self.sigma = (10 * math.log(1/self.delta) * math.pow(math.log(self.M), 1/4)) / math.sqrt(self.n) * self.epsilon
    ...
    def run_cache(self, query_id, blocks, budget):
        ...
        for round in range(self.k):
            ...
            true_output = self.scheduler.run_task(query_id, blocks, budget)     # Don't waste budget just yet
