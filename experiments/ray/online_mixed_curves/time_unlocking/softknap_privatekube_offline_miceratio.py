...
def grid():
    ...
    avg_number_tasks_per_block = [400, 700, 1000]
    ...
    data_path = [
        "privatekube_event_g0.0_l0.1_p=grid",
        "privatekube_event_g0.0_l0.3_p=grid",
        "privatekube_event_g0.0_l0.7_p=grid",
        "privatekube_event_g0.0_l0.9_p=grid",
